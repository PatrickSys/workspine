...
For required proof, independently recompute Candidate identity receipt values and reject links, directories, escaped paths, mismatches, or raw dirty-path disclosure. This validates local candidate provenance, not live process loading.
