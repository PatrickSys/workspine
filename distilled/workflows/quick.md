...
- Required quick browser proof declares Candidate identity paths and records exact Git/dirty/PLAN/artifact receipt values; it does not prove a live runtime loaded those bytes.
