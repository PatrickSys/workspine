...
// LEGACY INSTALLER SURFACE
// This script is retained for upstream/reference install flows and is not the
// primary GSDD bootstrap path. For GSDD project setup, use `npx gsdd init`.
